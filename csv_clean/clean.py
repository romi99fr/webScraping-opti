...
def main():
    ...
    column_order = ['Codi_Districte', 'Nom_Districte', 'Personas', 'Promedio_Import_Euros', 'Vehicles', 'Atur', '€/m2', 'Denuncias_Convivencia', 'Incidents_Degradacion', 
                    'Promedio_Vivienda', 'Habitatges_dus_turístic', 'Hotel', 'Residències estudiants', 'Parcs urbans', 'Arbres al carrer','Turismes','Superfície (km²)','Habitants/Turisme','Turismes/km²', 
                    'Total Guals', 'A peu + bicicleta','Transport privat', 'Transport públic', 'Nacionalitat espanyola','Nacionalitat estrangera',
                    'PoblacióTotal', 'Densitat de població (hab/km²)','Edat mitjana','Domicilis', 'Residencial','Equipaments','Indústria i infraestructures','Xarxa viària','Parcs forestals',
                    'Nombre de places aparcament Total','Nombre de places aparcament Residencies', 'Nombre de places aparcament Altres edificis', 'Nombre de Centres Civics']
